...
export default function ShowAllTradingMoviesScreen() {
  ...
  const getChangedMovies = async () => {
    try {
      ...
      const response = await fetch(
        `https://api.themoviedb.org/3/trending/movie/week?api_key=${constants.theMovieDb_API_KEY}&page=${currentPage}`,
      );
