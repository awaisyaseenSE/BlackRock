...
const TvSeriesDetailComponent = ({movieId, imageStyle, style, textStyle}) => {
    ...
    const fetchMovieData = async () => {
      try {
        ...
        const response = await fetch(
          `https://api.themoviedb.org/3/tv/${movieId}?api_key=${constants.theMovieDb_API_KEY}`,
        );
...
export default TvSeriesDetailComponent;
