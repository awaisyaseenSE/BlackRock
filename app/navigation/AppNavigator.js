...
import SpaceDetailScreen from '../screens/Space/SpaceDetailScreen';
...
function AppNavigator() {
  return (
    ...
    <Stack.Navigator>
      ...
      />
      <Stack.Screen
        name="WallpaperHomeScreen"
        component={WallpaperHomeScreen}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="WalllOnBoardingScreen"
        component={WalllOnBoardingScreen}
        options={{
          headerShown: false,
        }}
      />
      ...
      <Stack.Screen
        ...
        component={InvestBottomTab}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="AnimationPractiseScreen"
        component={AnimationPractiseScreen}
        options={{
          headerShown: false,
        }}
      />
